    ...
    return (
        <div className="card shadow-md">
            <div className="card-body">
                ...
                {
                    stacks.length === 0 ? <div className="border border-[#E2E8F0] border-dashed rounded-xl text-center px-6 py-6 text-[#94A3B8] text-xs">Your stack is empty</div> : <p className="text-xs text-[#94A3B8]">{`${stacks.length} Technology Selected`}</p>
                }
